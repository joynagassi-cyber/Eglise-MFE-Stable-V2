...
const RecurringTransactionModelSchema = CollectionSchema(
  ...
  indexes: {
    ...
    r'nextOccurrence': IndexSchema(
      id: 1967264179148233952,
      name: r'nextOccurrence',
      unique: false,
      replace: false,
      properties: [
...
int _recurringTransactionModelEstimateSize(
  ...
  bytesCount += 3 + object.nextOccurrence.length * 3;
  return bytesCount;
}
...
void _recurringTransactionModelSerialize(
  ...
  writer.writeString(offsets[4], object.jsonData);
  writer.writeDateTime(offsets[5], object.lastSyncedAt);
  writer.writeString(offsets[6], object.nextOccurrence);
}
...
RecurringTransactionModel _recurringTransactionModelDeserialize(
  ...
  object.isarId = id;
  object.jsonData = reader.readStringOrNull(offsets[4]);
  object.lastSyncedAt = reader.readDateTimeOrNull(offsets[5]);
  object.nextOccurrence = reader.readString(offsets[6]);
  return object;
}
...
extension RecurringTransactionModelByIndex
  ...
  RecurringTransactionModel? getByIdSync(String id) {
  ...
  Future<List<RecurringTransactionModel?>> getAllById(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
    return getAllByIndex(r'id', values);
  }

  List<RecurringTransactionModel?> getAllByIdSync(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
  ...
  Future<Id> putById(RecurringTransactionModel object) {
    return putByIndex(r'id', object);
  }

  Id putByIdSync(RecurringTransactionModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'id', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllById(List<RecurringTransactionModel> objects) {
    return putAllByIndex(r'id', objects);
  }

  List<Id> putAllByIdSync(List<RecurringTransactionModel> objects,
      {bool saveLinks = true}) {
...
extension RecurringTransactionModelQueryWhere on QueryBuilder<
  ...
  QueryBuilder<RecurringTransactionModel, RecurringTransactionModel,
      QAfterWhereClause> nextOccurrenceEqualTo(String nextOccurrence) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'nextOccurrence',
  ...
  QueryBuilder<RecurringTransactionModel, RecurringTransactionModel,
      QAfterWhereClause> nextOccurrenceNotEqualTo(String nextOccurrence) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
              indexName: r'nextOccurrence',
              lower: [],
              upper: [nextOccurrence],
              includeUpper: false,
            ))
            .addWhereClause(IndexWhereClause.between(
              indexName: r'nextOccurrence',
              lower: [nextOccurrence],
              includeLower: false,
              upper: [],
            ));
      } else {
...
extension RecurringTransactionModelQueryFilter on QueryBuilder<
  ...
  QueryBuilder<RecurringTransactionModel, RecurringTransactionModel,
      QAfterFilterCondition> nextOccurrenceEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RecurringTransactionModel, RecurringTransactionModel,
      QAfterFilterCondition> nextOccurrenceStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RecurringTransactionModel, RecurringTransactionModel,
      QAfterFilterCondition> nextOccurrenceEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RecurringTransactionModel, RecurringTransactionModel,
          QAfterFilterCondition>
      nextOccurrenceContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'nextOccurrence',
        value: value,
  ...
  QueryBuilder<RecurringTransactionModel, RecurringTransactionModel,
          QAfterFilterCondition>
      nextOccurrenceMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'nextOccurrence',
        wildcard: pattern,
  ...
  QueryBuilder<RecurringTransactionModel, RecurringTransactionModel,
      QAfterFilterCondition> nextOccurrenceIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'nextOccurrence',
        value: '',
  ...
  QueryBuilder<RecurringTransactionModel, RecurringTransactionModel,
      QAfterFilterCondition> nextOccurrenceIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'nextOccurrence',
        value: '',
...
extension RecurringTransactionModelQueryWhereDistinct on QueryBuilder<
  ...
  QueryBuilder<RecurringTransactionModel, RecurringTransactionModel, QDistinct>
      distinctByNextOccurrence({bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
