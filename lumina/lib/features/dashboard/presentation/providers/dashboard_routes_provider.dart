...
// Imports bible déplacés vers bible_routes_provider.dart
import '../../../bible/presentation/widgets/bible_view.dart'; // utilisé dans /dashboard/:type/bible
...
List<RouteBase> dashboardRoutes(DashboardRoutesRef ref) {
  return [
    ...
    // Routes bible déplacées vers bible_routes_provider.dart
  ];
}