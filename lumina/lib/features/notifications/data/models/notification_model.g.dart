...
extension NotificationModelByIndex on IsarCollection<NotificationModel> {
  Future<NotificationModel?> getByRemoteId(String remoteId) {
    return getByIndex(r'remoteId', [remoteId]);
  }

  NotificationModel? getByRemoteIdSync(String remoteId) {
  ...
  Future<List<NotificationModel?>> getAllByRemoteId(
      List<String> remoteIdValues) {
    final values = remoteIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'remoteId', values);
  }

  List<NotificationModel?> getAllByRemoteIdSync(List<String> remoteIdValues) {
    final values = remoteIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByRemoteId(NotificationModel object) {
    return putByIndex(r'remoteId', object);
  }

  Id putByRemoteIdSync(NotificationModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'remoteId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByRemoteId(List<NotificationModel> objects) {
    return putAllByIndex(r'remoteId', objects);
  }

  List<Id> putAllByRemoteIdSync(List<NotificationModel> objects,
      {bool saveLinks = true}) {
...
extension NotificationModelQueryProperty
  ...
  QueryBuilder<NotificationModel, String?, QQueryOperations> linkUrlProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NotificationModel, String, QQueryOperations> priorityProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NotificationModel, String, QQueryOperations> remoteIdProperty() {
    return QueryBuilder.apply(this, (query) {
