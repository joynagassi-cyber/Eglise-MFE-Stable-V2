...
ChatMessageModel _chatMessageModelDeserialize(
  ...
  object.readBy = reader.readStringList(offsets[7]) ?? [];
...
extension ChatMessageModelByIndex on IsarCollection<ChatMessageModel> {
  Future<ChatMessageModel?> getByRemoteId(String remoteId) {
    return getByIndex(r'remoteId', [remoteId]);
  }

  ChatMessageModel? getByRemoteIdSync(String remoteId) {
  ...
  Future<List<ChatMessageModel?>> getAllByRemoteId(
      List<String> remoteIdValues) {
    final values = remoteIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'remoteId', values);
  }

  List<ChatMessageModel?> getAllByRemoteIdSync(List<String> remoteIdValues) {
    final values = remoteIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByRemoteId(ChatMessageModel object) {
    return putByIndex(r'remoteId', object);
  }

  Id putByRemoteIdSync(ChatMessageModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'remoteId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByRemoteId(List<ChatMessageModel> objects) {
    return putAllByIndex(r'remoteId', objects);
  }

  List<Id> putAllByRemoteIdSync(List<ChatMessageModel> objects,
      {bool saveLinks = true}) {
...
extension ChatMessageModelQueryProperty
  ...
  QueryBuilder<ChatMessageModel, bool, QQueryOperations> isDeletedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isDeleted');
    });
  }

  QueryBuilder<ChatMessageModel, bool, QQueryOperations> isSyncedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isSynced');
    });
  }

  QueryBuilder<ChatMessageModel, String?, QQueryOperations> jsonDataProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessageModel, String, QQueryOperations> remoteIdProperty() {
    return QueryBuilder.apply(this, (query) {
