...
const SyncOperationModelSchema = CollectionSchema(
  ...
  indexes: {
    ...
    r'hasFailed': IndexSchema(
      id: 6786745434446705539,
      name: r'hasFailed',
      unique: false,
      replace: false,
      properties: [
...
extension SyncOperationModelQueryWhereSort
  ...
  QueryBuilder<SyncOperationModel, SyncOperationModel, QAfterWhere>
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        const IndexWhereClause.any(indexName: r'hasFailed'),
      );
    });
  }
}
...
extension SyncOperationModelQueryWhere
  ...
  QueryBuilder<SyncOperationModel, SyncOperationModel, QAfterWhereClause>
      hasFailedEqualTo(bool hasFailed) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'hasFailed',
        value: [hasFailed],
      ));
    });
  }
  ...
  QueryBuilder<SyncOperationModel, SyncOperationModel, QAfterWhereClause>
      hasFailedNotEqualTo(bool hasFailed) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
...
extension SyncOperationModelQueryProperty
  ...
  QueryBuilder<SyncOperationModel, int, QQueryOperations> isarIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncOperationModel, bool, QQueryOperations> hasFailedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'hasFailed');
    });
  }

  QueryBuilder<SyncOperationModel, bool, QQueryOperations> isSyncedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncOperationModel, String, QQueryOperations> payloadProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncOperationModel, String, QQueryOperations> userIdProperty() {
    return QueryBuilder.apply(this, (query) {
